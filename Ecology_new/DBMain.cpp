...
//void DBMain::setMonthlyResult(const std::map<int, wxString> &map_value)
//{
//
//	wxString strFirstPart;
//	wxString strSecondPart{ "" };
//	bool nextRow{true};
//	bool endOfMap{false};
//
//	if (!map_value.count(DB_COLUMN_CODE) || map_value.size()<3)
//		return;
//
//	m_rs = ExecuteQuery(wxS("SELECT * FROM " + DBStorageTableName + " WHERE Code = '"
//		+ map_value.at(DB_COLUMN_CODE) + "' AND Date LIKE '%" + map_value.at(DB_COLUMN_DATE) + "%'"));
//
//	if (!m_rs.NextRow())
//	{
//		strFirstPart = "INSERT INTO " + DBStorageTableName + " (";
//		strSecondPart = "VALUES (";
//		nextRow = false;
//	}
//	else
//	{
//		strFirstPart = "UPDATE " + DBStorageTableName + " SET ";
//
//	}
//
//	for (const auto& [columnId, value]: map_value)
//	{
//		if ((columnId == DB_COLUMN_DATE && columnId == map_value.rbegin()->first) 
//			|| (columnId == DB_COLUMN_CODE && columnId == map_value.rbegin()->first))
//			endOfMap = true;
//		if (columnId != DB_COLUMN_DATE && columnId != DB_COLUMN_CODE)
//		{
//		
//			if (!nextRow)
//			{
//				if (columnId == map_value.rbegin()->first || endOfMap == true)
//				{
//					if (columnId == DB_COLUMN_AMOUNT_SELFSTORAGE)
//					{
//
//						strFirstPart += m_dbStorageColumns[columnId] + ","+ m_dbStorageColumns[DB_COLUMN_AMOUNT_SELFSTORAGE_FULL] + 
//										"," + m_dbStorageColumns[DB_COLUMN_CODE] + "," + m_dbStorageColumns[DB_COLUMN_DATE] + ") ";
//						strSecondPart += "'" + value + "', '"+ value+ "', '" + map_value.at(DB_COLUMN_CODE) 
//										+ "', '" + map_value.at(DB_COLUMN_DATE) + "')";
//					
//					}
//					else
//					{
//						strFirstPart += m_dbStorageColumns[columnId] + ","+ m_dbStorageColumns[DB_COLUMN_CODE] + "," + m_dbStorageColumns[DB_COLUMN_DATE] + ") ";
//						strSecondPart += "'" + value + "', '" + map_value.at(DB_COLUMN_CODE) + "', '" + map_value.at(DB_COLUMN_DATE) + "')";
//						
//					}
//
//				}
...
//					{
//						strFirstPart += m_dbStorageColumns[columnId] + "," + m_dbStorageColumns[DB_COLUMN_AMOUNT_SELFSTORAGE_FULL]+",";
//						strSecondPart += "'" + value + "', '" + value + "', ";
//					}
//					else
//					{
//						strFirstPart += m_dbStorageColumns[columnId] + ",";
//						strSecondPart += "'" + value + "', ";
//					}
//				}
//			}
//			else if (m_rs.GetDouble(m_dbStorageColumns[columnId]) == 0)
//			{
//
//				if (columnId == map_value.rbegin()->first || endOfMap == true)
//				{
//					if (columnId == DB_COLUMN_AMOUNT_SELFSTORAGE)
//					{
//						double amount, amountFull;
//						value.ToDouble(&amount);
//						amountFull = m_rs.GetDouble(m_dbStorageColumns[DB_COLUMN_AMOUNT_SELFSTORAGE_FULL]) + amount;
//
//						strFirstPart += m_dbStorageColumns[columnId] + " = '" + value + "', "+ m_dbStorageColumns[DB_COLUMN_AMOUNT_SELFSTORAGE_FULL]
//							+" = '"+ wxString::Format(wxS("%f"), amountFull) + "' WHERE Code = '"
//							+ map_value.at(DB_COLUMN_CODE) + "' AND Date LIKE '%" + map_value.at(DB_COLUMN_DATE) + "%'";
//					}
//					else
//					{
//						strFirstPart += m_dbStorageColumns[columnId] + " = '" + value + "' WHERE Code = '"
//							+ map_value.at(DB_COLUMN_CODE) + "' AND Date LIKE '%" + map_value.at(DB_COLUMN_DATE) + "%'";
//					}
//
//				}
...
//						amountFull = m_rs.GetDouble(m_dbStorageColumns[DB_COLUMN_AMOUNT_SELFSTORAGE_FULL]) + amount;
//
//						strFirstPart += m_dbStorageColumns[columnId] + " = '" + value + "', " + m_dbStorageColumns[DB_COLUMN_AMOUNT_SELFSTORAGE]
//										+ " = '" + wxString::Format(wxS("%f"), amountFull) + "', ";
//
//					}
//					else
//					{
//						strFirstPart += m_dbStorageColumns[columnId] + " = '" + value + "', ";
//					}
//				}
//			}
//			else
...
//				value.ToDouble(&amount);
//				amountFull = m_rs.GetDouble(m_dbStorageColumns[DB_COLUMN_AMOUNT_SELFSTORAGE_FULL]) + amount;
//				amount += m_rs.GetDouble(m_dbStorageColumns[columnId]);
//			
//
//				if (columnId == map_value.rbegin()->first || endOfMap == true)
//				{
//					if (columnId == DB_COLUMN_AMOUNT_SELFSTORAGE)
//					{
//						strFirstPart += m_dbStorageColumns[columnId] + " = '" + wxString::Format(wxS("%f"), amount) 
//							+ "', "+ m_dbStorageColumns[DB_COLUMN_AMOUNT_SELFSTORAGE_FULL] + " = '" + wxString::Format(wxS("%f"), amountFull) 
//							+"' WHERE Code = '" + map_value.at(DB_COLUMN_CODE) + "' AND Date LIKE '%" + map_value.at(DB_COLUMN_DATE) + "%'";
//					}
//					else
//					{
//						strFirstPart += m_dbStorageColumns[columnId] + " = '" + wxString::Format(wxS("%f"), amount) + "' WHERE Code = '"
//							+ map_value.at(DB_COLUMN_CODE) + "' AND Date LIKE '%" + map_value.at(DB_COLUMN_DATE) + "%'";
//					}
//
//				}
...
//		
//	}
//	ExecuteUpdate(strFirstPart + strSecondPart);
//	m_rs.Finalize();
//}
